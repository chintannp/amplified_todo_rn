...
const defaultProviders = {
    ...
    colors: createBaseMod_1.provider({
        getFilePath({ modRequest: { projectRoot } }) {
            return android_1.Colors.getProjectColorsXMLPathAsync(projectRoot);
        },
        async read(filePath) {
            return android_1.Resources.readResourcesXMLAsync({ path: filePath });
        },
    ...
    styles: createBaseMod_1.provider({
        getFilePath({ modRequest: { projectRoot } }) {
            return android_1.Styles.getProjectStylesXMLPathAsync(projectRoot);
        },
        async read(filePath) {
            return android_1.Resources.readResourcesXMLAsync({ path: filePath });
        },
