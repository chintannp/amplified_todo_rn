 ...
 * This is akin to creating a new code file in Xcode with `⌘+n`.
 */
export declare function addBuildSourceFileToGroup({ filepath, groupName, project, verbose, }: {
    filepath: string;
    groupName: string;
    project: XcodeProject;
    verbose?: boolean;
}): XcodeProject;
export declare function addFileToGroupAndLink({ filepath, groupName, project, verbose, addFileToProject, }: {
    filepath: string;
    groupName: string;
    project: XcodeProject;
    verbose?: boolean;
