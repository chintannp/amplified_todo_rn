 ...
 * This is akin to creating a new code file in Xcode with `⌘+n`.
 */
function addBuildSourceFileToGroup({ filepath, groupName, project, verbose, }) {
    return addFileToGroupAndLink({
        filepath,
        groupName,
        project,
...
function addFileToGroupAndLink({ filepath, groupName, project, verbose, addFileToProject, }) {
